...
@Component({
  ...
  template: `
    <section class="mt-16">
      <p class="mb-8 text-2xl text-gray-900 dark:text-white inline-block">Carreer Span</p>
        ...
        <div
          ...
          <div class="relative h-full dark:bg-slate-900 bg-white p-6 pb-8 rounded-[inherit] overflow-hidden">
            ...
            <div class="flex flex-col gap-3 text-center">
              ...
              <span class="text-xl font-semibold dark:text-white">{{s.yearsOfPractice}}</span>
